...
const sheetVariants = cva(
  "fixed z-40 scale-100 modal-box opacity-100 animate-in max-h-screen",
  {
    variants: {
      position: {
        top: "slide-in-from-top w-full",
        bottom: "slide-in-from-bottom w-full",
        left: "slide-in-from-left h-full",
        right: "slide-in-from-right h-full",
      },
      size: {
        content: "",
        default: "",
